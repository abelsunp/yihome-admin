<template>
    <section  v-loading.fullscreen.lock="fullscreenLoading">
        <!-- 用户状态设置 -->
        <div style="padding:16px;" v-hasPermi="['user:channeluser:edit']">
            <!-- {{currentUserId}} -->
            <span>客户状态：</span>
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick" class="mytab" v-loading="recordDataLoading">
            <el-tab-pane label="跟进记录" name="first" >
                ...
                <div class="createRecord">
                    <div class="content" v-if="createdStatus" @click="createdClick"  v-hasPermi="['user:channeluser:createdFollow']">
                                    ...
                                    <div class="keep-scroll-title">
                                        ...
                                        <el-dropdown class="keep-right">
                                            ...
                                            <el-dropdown-menu slot="dropdown">
                                                <el-dropdown-item v-hasPermi="['user:channeluser:editFollow']">
                        ...
                        <li>
                            <el-row>
                                <el-col :span="12">
                                    ...
                                    <div class="value">{{userData.birthday}}</div>
                                </el-col>
                                <el-col :span="12">
            ...
            <el-tab-pane label="订单信息" name="third">
                ...
                <div class="order-table">
                    <el-table :data="OrdertableData" style="width: 100%">
                        ...
                        <el-table-column  prop="currentName" label="姓名" align="center" width="80px"> </el-table-column>
...
export default {
    ...
    components: { importTable,addOrderc,houseList,userList },
    data(){
        return {
            activeName: 'first',
            statusData:[],
