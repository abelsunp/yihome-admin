<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          >删除</el-button>
          <span v-if="scope.row.parentId != 0 " style="margin-left:10px;">
    ...
    <el-drawer
      ...
      custom-class="changecommission-drawer"
      size="880px">
...
export default {
  name: "Dept",
  components: { Treeselect,commissionComponent },
  data() {
    return {
...
<style>
.changecommission-drawer .el-drawer__body{
  overflow: auto;
  padding-bottom: 20px;
}
</style>