<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
        ...
        <el-button type="primary" :disabled="multiple" @click="settlement">结算</el-button>
    </el-row>
...
import { getBatchInnerMoney } from "@/api/order/order";
...
export default {
  ...
  methods: {
    ...
    settlement(){
        ...
        getBatchInnerMoney(this.ids).then(res=>{
          loading.close();
          if(res.code===200){
